...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="skin/images/tbg.fig" bgcolor="#E7E7E7">&nbsp;系统设置&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td width="10%">关键字</td>
	<td width="90%" align="left"><input name="name" type="text" id="name" size="50" value="<?php echo $keyword;?>"></td>
</tr>
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
  <td>网站描述</td>
